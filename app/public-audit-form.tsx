        ...
        {report && (
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3 rounded-lg border border-emerald-400/20 bg-emerald-400/10 p-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="font-semibold text-white">Need private repo coverage?</p>
                <p className="mt-1 text-sm text-zinc-300">Run the full audit with GitHub OAuth, billing flow, and shareable report history.</p>
              </div>
              <Link
                href="/dashboard"
